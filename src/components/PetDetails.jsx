...
const PetDetails = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-[90vh] gap-2 mx-auto">
      <div className="flex flex-col gap-2 text-left bg-slate-300 rounded-md p-5">
        <div>
          <button
        ...
        <p className=" text-justify"><span className=" font-bold">Description: </span> {selectedPet.description}</p>
